...
class Card {
  constructor(parent,config){
    ...
    this.load.on('complete',()=>{
      ...
      let bg_ranks=new createjs.SpriteSheet({
        "images":["../src/assets/ranknumb.png"],
        "frames":{
          "height":70,
          "width":180,
          "count":10
  ...
  changeRank(value){
    ...
    if(this.rnum){
      ...
      createjs.Tween.get(this.rnum, {override:true})
      .to({y:733-330,alpha:0}, 1000)
      .call(function(){
      ...
      this.rnumb.alpha=0;
      createjs.Tween.get(this.rnumb, {override:true})
      .to({y:733-165,alpha:1}, 1000)
      .call(function(){
      createjs.Tween.get(this.rnumb, {override:true})
        this.rnumb.y=733;
      }.bind(this));
